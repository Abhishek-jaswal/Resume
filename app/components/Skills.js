...
import { Code2, Server, Database, Terminal, Box, Briefcase, Layers } from "lucide-react";
...
const skillsData = [
  {
    ...
    skills: [
      ...
      "React.js", "Next.js 14", "Tailwind CSS", "Framer Motion",
    ],
  },
  {
    icon: Server,
    ...
    skills: [
      ...
      "Authentication", "Authorization", "JWT", "PocketBase",
    ],
  },
  {
    icon: Database,
    ...
    skills: ["PostgreSQL", "MySQL", "Supabase", "Hasura"],
  },
  {
    icon: Box,
    title: "DevOps & Tools",
    ...
    skills: [
      ...
      "AWS (Basics)", "Vercel", "Railway", "Netlify",
    ],
  },
  {
    icon: Briefcase,
    ...
    skills: [
      "CRM Data Handling", "Dashboard Management",
      "Workflow Automation", "Excel Advanced",
    ],
  },
  {
    icon: Terminal,
    ...
    skills: ["JavaScript", "TypeScript", "Python", "Java", "C++", "Rust (Learning)"],
  },
];
...
export default function Skills() {
  ...
  return (
    ...
    >
      <meta itemProp="name" content="Abhishek Jaswal — Technical Skills" />

      {/* Background ambient */}
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-green-500/[0.04] blur-[80px] rounded-full pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-500 mt-4 max-w-xl mx-auto leading-relaxed">
            A comprehensive toolkit of modern technologies for building exceptional
            digital experiences — from pixel-perfect UIs to scalable backend systems.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div
                    className={`p-2.5 rounded-xl ${category.iconBg} ${category.iconHover} transition-colors duration-200`}
                  >
                ...
                {/* Skills */}
                <ul className="flex flex-wrap gap-2" role="list" aria-label={`${category.title} skills`}>
