     ...
     <LocalTime />
      <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center" id='about'>
        ...
        <div>
          ...
          <div className="text-4xl font-extrabold text-green-500 mt-4">
            <Typewriter
              options={{
        ...
        <div className="relative flex justify-center">
          <div className="relative w-60 h-60 md:w-80 md:h-80 border-2 border-green-500 rounded-full overflow-hidden">
            <Image
              src="/abhishekk.jpeg"
              alt="Profile Picture"
              fill
