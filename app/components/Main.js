...
function Main() {
  return (
    <section
      ...
      className="relative flex items-center justify-center px-6 mt-20 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          >
            Hi, I&apos;m{" "}
            <span className="text-green-500">Abhishek Jaswal</span>
          </h1>

          {/* Typewriter */}
          <div
            className="text-2xl font-extrabold text-green-500 mt-4"
            aria-live="polite"
          >
            <Typewriter
              options={{
          ...
          >
            ...
            with expertise in modern technologies including JavaScript,
            ReactJS, Express.js, Django, and Rust.
          </motion.p>
          ...
          >
            ...
            applications, and seamless user interfaces that deliver
        ...
        >
          ...
          <div
            aria-hidden="true"
            className="absolute inset-0 rounded-full bg-gradient-to-r from-green-500 to-cyan-400 blur-2xl opacity-30 animate-pulse"
          />
          ...
          <motion.div
            ...
            className="relative w-60 h-60 md:w-80 md:h-80 rounded-full overflow-hidden border border-green-500/40 shadow-xl"
          >
            <Image
              src="/abhishekk.jpeg"
          ...
          <motion.div
            ...
            className="absolute -top-4 -right-4 px-4 py-2 rounded-lg bg-white/10 backdrop-blur text-sm hidden sm:block"
          >
            💻 Full-Stack
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute -bottom-2 -left-4 px-4 py-2 rounded-lg bg-white/10 backdrop-blur text-sm hidden sm:block"
          >
            ⚡ 3+ Years
          </motion.div>
        </motion.div>
